...
<?php 
    ...
    <form action="../PHP/post_rent.php" method="post">
        ...
        <div class="sumit_button">
            <a href="lo_filtrate.php"><input type="button" name="sumit"  value="filtrate" style="border: 0;background-color: #826D6D; color: white;font-size: 13px; width: 120px;height: 30px;">
        </div>
    </form>
    </section>
