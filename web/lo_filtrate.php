...
<body>
    ...
    <header class="head" id="head">
        ...
        ?>
        <div class="photo">
            <a href="lo_myprofile.php"><img src="<?php echo $info['tn_photo'] ?>" alt="some_text" width="50" height="50" style="border-radius: 50%;margin-top: 25px;margin-left: 122px;"></a>     
        </div>
        <?php
            }
            else{
    ...
    <div class="house2">
        <div class="house_photo">
            <a href="roomdetails..php"><img src="../web/coverage/room3.jpg" alt="some_text" width="100%" height="180px" style="border-radius: 0px 15px 0 0;"></a>
        </div>
        <div class="big_title">
